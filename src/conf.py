...
BLOG_AUTHOR = "Willy Kuo"
BLOG_TITLE = "Willy's blog"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://waitingkuo.github.io"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "waitingkuo0527@gmail.com"
BLOG_DESCRIPTION = "My Tech Home"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://twitter.com/waitingkuo', 'My Twitter', 'icon-twitter'),
        ('https://github.com/waitingkuo', 'My Github', 'icon-github'),
    ...
    'es': (
        ...
        ('https://twitter.com/waitingkuo', 'Mi Twitter', 'icon-twitter'),
        ('https://github.com/waitingkuo', 'Mi Github', 'icon-github'),
